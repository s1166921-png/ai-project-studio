...
const toolDetails: Record<string,Partial<Project>> = {
 yundai:{status:'网页已上线',audience:'跨境企业经营者 · 融资顾问',experience:['查看渐进式经营资料采集方式','理解产品候选与规则解释','查看 AI 分析如何交给顾问复核'],accessNote:'可直接访问美鸥云贷网页，查看 AI 诊断、准入评估与产品方案入口。',links:[{label:'打开美鸥云贷',url:'https://yundai.meiouyuncang.com/',kind:'在线网页',note:'美鸥云贷 · 跨境经营融资咨询与 AI 诊断入口'}]},
